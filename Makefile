...
LIBOBJS = ${LIBSRCS:.c=.o}
CHKSRCS = checker.c stack.c
CHKOBJS = ${CHKSRCS:.c=.o}
PUSHSRCS = push_swap.c
...
.c.o : ${LIBSRCS} ${CHKSRCS} ${SWAPSRCS}
	${CC} ${CFLAGS} -c $< -o $@

$(LIBNAME) : ${LIBOBJS}
	${AR} ${ARFLAGS} ${LIBNAME} ${LIBOBJS}

$(CHKNAME) : ${CHKOBJS} ${LIBNAME}
	${CC} ${CFLAGS} ${LIBFLAGS} $^ -o $@

$(SWAPNAME) : ${PUSHOBJS} ${LIBNAME}
	${CC} ${CFLAGS} ${LIBFLAGS} $^ -o $@

clean :
	rm -rf ${LIBOBJS} ${CHKOBJS} ${PUSHOBJS}
